...
import { SiMicrosoft, SiMongodb, SiUdemy, SiLeetcode, } from "react-icons/si";
...
function EducationAndExperience() {
  return (
                ...
                return (
                  <div className="hs-carousel-slide relative" key={index}>
                    {cert.icon === "microsoft" ? (
                      ...
                      <SiMongodb className="text-blue-500 absolute right-5 top-3 text-3xl" />
                    ): cert.icon === "udemy" ? (
                        <SiUdemy className="text-blue-500 absolute right-5 top-3 text-3xl" />
                    ): cert.icon === "greatlearning" ? (
                        <SiLeetcode className="text-blue-500 absolute right-5 top-3 text-3xl" />
                    ) :(
                      <SiLeetcode className="text-green-500 absolute right-5 top-3 text-3xl" />
                    )}
    ...
    <section
        id="achievements"
        className="mt-20 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-12 lg:px-16"
    >
      {user_info.achievements.map((achievement, index) => {
        return (
            <div
                key={index}
            ...
            >
              ...
              <p className="leading-7 text-zinc-500 dark:text-zinc-300 font-light text-base mt-2">
                {achievement.description}
              </p>

              <a className="leading-7 text-zinc-500 dark:text-red-800 font-bold text-base mt-2" href={achievement.link}>
                {achievement.link}
              </a>
            </div>
        );
